        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pofil Akun User</h4>
                  <p class="card-description">
                    Buat Akun User
                  </p>
                  <div class="">
                    <form class="forms-sample" action="proses/createacc.php" method="POST">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group w-50">
                            ...
                            <input type="text" class="form-control border-top-0 border-left-0 border-right-0 border-dark" id="exampleInputName1" name="email" placeholder="mail@mail.com">
                          </div>
                          <div class="form-group w-50">
                            <label for="exampleInputName1">No HP</label>
                            <input type="text" class="form-control border-top-0 border-left-0 border-right-0 border-dark" id="exampleInputName1" name="nohp" placeholder="+62xxxxx">
                          </div>
                        </div>
                        <div class="col-md-6 w-50">
                          <div class="form-group w-50">
                            <label for="exampleInputName1">Username</label>
                            <input type="text" class="form-control border-top-0 border-left-0 border-right-0 border-dark" id="exampleInputName1" name="username" placeholder="Masukkan Username">
                          </div>
                          <div class="form-group w-50">
                            <label for="exampleInputName1">Password</label>
                            <input type="password" class="form-control border-top-0 border-left-0 border-right-0 border-dark" id="exampleInputName1" name="password" placeholder="******">
                          </div>
                      ...
                      <div class=" my-4 d-flex justify-content-center align-content-center">
                        <button type="submit" name="create" class="btn btn-success mr-2">Submit</button>
                        <button class="btn btn-light">Cancel</button>
                      </div>
                      <!-- <div class="form-group">
            ...
            <div class="col-md-12 grid-margin stretch-card card py-4">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">List Akun User</h4>
                            ...
                            <tr>
                              ...
                              <td class="mx-2">
                                <div class="d-flex justify-content-center align-content-center">
                                  <a href="" class="btn btn-outline-primary mr-2"><i class="fa fa-eye" aria-hidden="true"> Lihat</i></a>
                                  <a href="edit_user.php?id=<?php echo $data['id_user'] ?>" class="btn btn-outline-warning mr-2"><i class="fa fa-wrench" aria-hidden="true"> Edit</i></a>
                                  <a class="btn btn-outline-danger" href="proses/proses_hapus.php?id=<?php echo $data['id_user'] ?>"><i class="fa fa-trash" aria-hidden="true"> Hapus</i></a>
                                </div>
                              </td>
                            </tr>
                        <?php
