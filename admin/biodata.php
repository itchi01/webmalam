                    ...
                    <form class="" action="" method="POST" enctype="multipart/form-data">
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="nama_lengkap" class="form-control" id="inputEmail4" placeholder="Masukkan Nama">
                        </div>
                        <div class="form-group col-md-6">
          ...
          function tampil_data($koneksi)
          {
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="biodata.php?aksi=update&id=<?php echo $data['id_biodata']; ?>&nama_lengkap=<?php echo $data['nama']; ?>&nohp=<?php echo $data['no_hp']; ?>&alamat=<?php echo $data['alamat']; ?>&tempat_lahir=<?php echo $data['tempat_lahir']; ?>&tanggal_lahir=<?php echo $data['tanggal_lahir']; ?>&jenis_kelamin=<?php echo $data['jenis_kelamin']; ?>&foto=<?php echo $data['foto']; ?> " type="button" class="btn btn-outline-primary">Edit</a>
                                <a href="biodata.php?aksi=delete&id=<?php echo $data['id_biodata']; ?>" type="button" class="btn btn-outline-primary">Hapus</a>
                              </td>
                            </tr>
                          <?php
                            ++$no;
            ...
            function ubah($koneksi)
            {
              if (isset($_POST['ubah_biodata'])) {
                ...
                if (!empty($id)) {
                  $query_update = mysqli_query($koneksi, "UPDATE biodata SET nama = '$nama', no_hp = '$nohp', tanggal_lahir = '$tanggal_lahir', tempat_lahir = '$tempat_lahir', jenis_kelamin = '$jenis_kelamin', alamat = '$alamat', foto = '$foto' WHERE id_biodata = '$id'");
              ...
              ?>
                ...
                <nav class="nav"><a href="biodata.php" class="btn-lg"><i class=" fa fa-times" aria-hidden="true"></i></a></nav>
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <form class="" action="" method="POST" enctype="multipart/form-data">
